...
def set_baseline_nonlinconfreg_0_60_yesyesno(baseline):
    baseline["number_of_points"] = 2
    # [[0, 0], [0, 8], [9, 0], [9, 8]]
    baseline["intervals"] = [ \
        [6.7907731061799651e-05, 7.1602171291492028e-05], \
        [5999165.6003480637, 6018071.3564086333], \
        [0.00077069320765920551, 0.008309778010451253], \
        [0.018583833330068179, 1.8583833330068178]]
    return baseline
