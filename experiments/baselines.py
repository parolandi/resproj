...
def set_baseline_nonlinconfreg_0_60_yes10yes15no5(baseline):
    baseline["number_of_points"] = 0
    # [8, 9], [8, 9], [9, 4], [9, 9]
    baseline["intervals"] = [ \
...
def set_baseline_nonlinconfreg_0_60_yes15no5yes10(baseline):
    baseline["number_of_points"] = 0
    # [4, 8], [9, 9], [9, 8], [9, 8]
    baseline["intervals"] = [ \
...
def set_baseline_linconfreg_0_60_yesyesno(baseline):
    #[  7.60646450e-05   3.65055439e+07   5.08452377e-02   3.32139343e+00]
    baseline["intervals"] = [ \
        [-5.164386299615336e-06, 0.00014696490375974415], \
        [-30491392.699101456, 42519695.162494995], \
        [-0.043138305644620442, 0.058552169797804546], \
        [-3.1355550927331914, 3.5072317593345548]]
    baseline["ellipsoid"] = [ \
        [  1.87446823e-08, -3.32027281e+03,  2.52321062e-06, -6.59136271e-05], \
        [ -3.32027281e+03,  4.31747714e+15, -5.49521082e+06,  3.97838181e+07], \
        [  2.52321062e-06, -5.49521082e+06,  8.37554282e-03, -2.38619439e-01], \
        [ -6.59136271e-05,  3.97838181e+07, -2.38619439e-01,  3.57398761e+01]]
    baseline["delta"] = [ \
        [  0.00000001e-08,  0.00000001e+03,  0.00000001e-06,  0.00000001e-05], \
        [  0.00000001e+03,  0.00000001e+15,  0.00000001e+06,  0.00000001e+07], \
        [  0.00000001e-06,  0.00000001e+06,  0.00000001e-03,  0.00000001e-01], \
        [  0.00000001e-05,  0.00000001e+07,  0.00000001e-01,  0.00000001e+01]]
    return baseline

# --------------------------------------------------------------------------- #
# Yes10-yes15-no5 0-60 hr

def set_baseline_linconfreg_0_60_yes10yes15no5(baseline):
    #[  7.58447818e-05   3.02036788e+07   5.73470850e-02   6.82621374e-01]
    baseline["intervals"] = [ \
        [-4.5563220721658138e-06, 0.00014713324151273985], \
        [-24427003.019844852, 35980354.668883197], \
        [-0.048027398687459269, 0.066666771286155571], \
        [-0.63934624873010659, 0.72589649849966265]]
    baseline["ellipsoid"] = [ \
        [  1.77114604e-08, -2.83473830e+03,  2.90458740e-06, -1.89709480e-05], \
        [ -2.83473830e+03,  2.80881185e+15, -3.61434281e+06, -7.41260507e+06], \
        [  2.90458740e-06, -3.61434281e+06,  1.01257140e-02, -7.39056854e-02], \
        [ -1.89709480e-05, -7.41260507e+06, -7.39056854e-02,  1.43470538e+00]]
    baseline["delta"] = [ \
        [  0.00000001e-08,  0.00000001e+03,  0.00000001e-06,  0.00000001e-05], \
        [  0.00000001e+03,  0.00000001e+15,  0.00000001e+06,  0.00000001e+06], \
        [  0.00000001e-06,  0.00000001e+06,  0.00000001e-02,  0.00000001e-02], \
        [  0.00000001e-05,  0.00000001e+06,  0.00000001e-02,  0.00000001e+00]]
    return baseline

# --------------------------------------------------------------------------- #
# Yes15-no5-yes10 0-60 hr

def set_baseline_linconfreg_0_60_yes15no5yes10(baseline):
    #[  7.56413819e-05   3.32428272e+07   9.26934095e-02   4.66446884e-01]
    baseline["intervals"] = [ \
        [-3.4337541799728868e-06, 0.00014784900954937369], \
        [-27232884.120850474, 39252770.357113846], \
        [-0.081555944832416849, 0.10383087409866856], \
        [-0.44614423954160426, 0.48674952834241331]]
    baseline["ellipsoid"] = [ \
        [  1.92331211e-08, -3.13558557e+03,  2.68448000e-06, -4.01900051e-06], \
        [ -3.13558557e+03,  3.71472580e+15, -1.74218920e+06, -2.07963655e+07], \
        [  2.68448000e-06, -1.74218920e+06,  2.88820869e-02, -1.19316904e-01], \
        [ -4.01900051e-06, -2.07963655e+07, -1.19316904e-01,  7.31366813e-01]]
    baseline["delta"] = [ \
        [  0.00000001e-08,  0.00000001e+03,  0.00000001e-06,  0.00000001e-06], \
        [  0.00000001e+03,  0.00000001e+15,  0.00000001e+06,  0.00000001e+07], \
        [  0.00000001e-06,  0.00000001e+06,  0.00000001e-02,  0.00000001e-01], \
        [  0.00000001e-06,  0.00000001e+07,  0.00000001e-01,  0.00000001e-01]]
    return baseline
